import { Bot, Building2, Users, GraduationCap } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="section-title">
              Builder at heart,<br />
              <span className="bg-gradient-primary bg-clip-text text-transparent">innovator</span> by mission.
            </h2>
          ...
          <div className="lg:col-span-7 space-y-5 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              <span className="text-foreground font-semibold">over $500,000 annually.</span>
            </p>
            <p>
              ...
              <span className="text-foreground font-semibold">Velio Tech</span>, a company focused on helping underserved business owners adopt AI without needing a technical background.
            </p>
            <p>
            ...
            <p>
              ...
              <span className="text-foreground font-semibold">Florida International University</span>{" "}
              (Dean's List, Cum Laude) and am currently completing my{" "}
              <span className="text-foreground font-semibold">Master's in Engineering Management</span>. My passion for learning and teaching directly influences how I design AI solutions — practical, human-centered, and built to create real value.
            </p>
          </div>
        </div>
      </div>
