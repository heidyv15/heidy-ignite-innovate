      ...
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="section-title">
            ...
            <span className="bg-gradient-primary bg-clip-text text-transparent">Real business impact.</span>
          </h2>
              ...
              <div className="grid lg:grid-cols-12 gap-8 items-start">
                <div className="lg:col-span-8 space-y-4">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span className="chip text-xs bg-primary-soft text-primary">{p.tag}</span>
                  </div>
                  <h3 className="text-2xl font-bold">{p.title}</h3>
                  <p className="text-muted-foreground font-medium">{p.short}</p>
